...
export const PREP_FC_UI = {
  ...
  cols: [['#', ''], ['รายการ', ''], ['เฉลี่ย 6 วัน', '(กก.)'], ['พยากรณ์', '(กก.)'], ['ต่ำสุด', '(กก.)'], ['สูงสุด', '(กก.)'], ['แนวโน้ม', ''], ['WAPE', '(%)'], ['ย้อนหลัง 10 วัน', '']],
  status: {
    insufficient: 'ข้อมูลยังไม่พอ',
  ...
  liveHead: 'ความแม่นยำใช้จริง (เทียบกับที่ใช้จริงแต่ละวัน)',
  liveLoading: 'กำลังเติมผลจริงและคำนวณความแม่นยำใช้จริง...',
  liveNone: 'ยังไม่มีวันที่มีผลใช้จริงให้เทียบ',
  liveNotEnough: 'เทียบได้ {n} วัน ต้องมีอย่างน้อย {d} วันจึงบอกความแม่นได้',
  liveWin: 'แม่น {w}% จาก {n} วันที่เทียบได้ (ใช้จริงอยู่ในช่วงต่ำสุด–สูงสุด)',
  liveItem: '{name}: เทียบได้ {n} วัน · {acc} · คลาดเคลื่อนเฉลี่ย {avg} กก. สูงสุด {max} กก.',
  liveItemAcc: 'แม่น {w}% · WAPE {wape}',
  wapeNeed: '{n}/{need} วัน',
  wapeNone: 'คำนวณไม่ได้',
  backLine: '{name}: ทดสอบ {n} วัน · {acc}',
  backAcc: 'แม่น {w}% · WAPE {wape}',
  ...
  liveNoBand: 'ยังไม่มีช่วงต่ำสุด–สูงสุด จึงยังเก็บผลไว้เทียบไม่ได้: {names}',
  liveSaved: 'เก็บผลพยากรณ์ของ {d} ไว้เทียบแล้ว {n} รายการ',
  ...
  backHead: 'ผลทดสอบย้อนหลัง (ยังไม่ใช่ความแม่นยำใช้จริง)',
  ...
  rules: 'วิธีวัด: นับเฉพาะวันที่พยากรณ์ล่วงหน้าจริง · ช่วงต่ำสุด–สูงสุดตามที่ตั้งไว้รายวัตถุดิบ · สูตรยอดขายใช้ยอดขายของวันเปิดก่อนหน้าเท่านั้น · ความแม่นยำต้องมีอย่างน้อย {days} วัน · ไม่นับวันอาทิตย์และวันที่ไม่มีข้อมูล · แก้กติกาได้ที่หน้า "ตั้งค่ากฎการทดสอบ"',
  // คำเตือนของพยากรณ์ (t = ป้ายสั้นไม่เกิน 15 ตัวอักษร · d = รายละเอียดในกล่อง · day = ข้อความบนแถบบนตารางเมื่อเกิดกับเกือบทุกรายการ)
  issue: {
    more: 'และอีก {n} เรื่อง',
    many: 'มี {n} เรื่อง',
    insufficient: { t: 'ข้อมูลไม่พอ', d: 'ประวัติใช้จริงยังน้อยเกินไป สูตรจึงยังคำนวณไม่ได้', day: 'ข้อมูลใช้จริงยังไม่ถึงเกณฑ์ หลายรายการจึงยังพยากรณ์ไม่ได้' },
    noBand: { t: 'ข้อมูลไม่พอ', d: 'มีค่าพยากรณ์แล้ว แต่ข้อมูลยังไม่พอคำนวณช่วงต่ำสุด–สูงสุด (มี {n} ค่า ต้องการ {need} ค่า)', day: 'ข้อมูลใช้จริงยังไม่ถึงเกณฑ์ จึงยังคำนวณช่วงต่ำสุด–สูงสุดไม่ได้' },
    noSales: { t: 'รอยอดขาย', d: 'สูตรนี้ใช้ยอดขายของวันเปิดก่อนหน้า ซึ่งยังไม่ได้บันทึก', day: 'ยังไม่มียอดขายของวันเปิดก่อนหน้า สูตรที่ใช้ยอดขายจึงยังคำนวณไม่ได้' },
    noModel: { t: 'ยังไม่ตั้งสูตร', d: 'รายการนี้ยังไม่ได้เลือกสูตรพยากรณ์ เลือกได้ที่หน้าสมการ Forecast' },
    noFixed: { t: 'ยังไม่ใส่ปริมาณ', d: 'ตั้งเป็นเตรียมคงที่ไว้ แต่ยังไม่ได้ใส่ปริมาณ' },
    modelNew: { t: 'สูตรเพิ่งเปลี่ยน', d: 'สูตรพยากรณ์ของรายการนี้เพิ่งเปลี่ยน ตัวเลขอาจต่างจากที่เคยเห็น' },
    noRice: { t: 'ยังไม่รองรับ', d: 'ยังพยากรณ์รายการนี้ไม่ได้' },
    noCtx: { t: 'โหลดไม่ครบ', d: 'โหลดข้อมูลพยากรณ์ไม่ครบ ลองเปิดหน้านี้ใหม่' },
    noFallback: { t: 'ยังพยากรณ์ไม่ได้', d: 'สูตรหลักคำนวณไม่ได้วันนี้ และยังไม่มีสูตรสำรองที่ผ่านการทดสอบ' },
    cfgBad: { t: 'ตั้งค่าไม่ครบ', d: 'ค่ากฎการพยากรณ์บางข้อหายหรือผิด จึงคำนวณไม่ได้ แก้ได้ที่หน้าตั้งค่ากฎการทดสอบ' },
...
export const BURMESE_STAFF = ['som'];   // รหัสพนักงาน (ค่าเดียวกับ staffCode()) ที่หน้านับเครื่องดื่มแสดงชื่อพม่าใต้ชื่อไทย

// แท็บ "แปลภาษาพม่า" ในหน้างานของส้ม (ข้อความไทยทั้งหมด · คำพม่ามาจากตาราง kk_word_my / kk_app_word_my เท่านั้น)
export const SOM_MY_UI = {
  tab: {
    id: 'translate', tab: 'แปลภาษา\nพม่า', glyph: 'lang',
    title: 'แปลภาษาพม่า', sub: 'กรอกคำภาษาพม่าตามภาษาไทยทีละหมวด พิมพ์เสร็จแล้วแตะที่อื่น ระบบบันทึกให้ทันที',
    char: 'assets/som/som-kimono.webp', bubble: 'ค่อยๆ แปล\nทีละหมวด\nนะคะ ♡', script: 'Thai → Myanmar ♡'
  },
  sections: [
  ...
  unit: 'หน่วย',
  add: 'เพิ่มคำ',
  addTitle: 'เพิ่มคำภาษาพม่าให้รายการไหน',
  addFree: '+ คำใหม่ (ไม่ผูกกับรายการนับ)',
  addForm: { title: 'เพิ่มคำใหม่', th: 'คำภาษาไทย', unit: 'หน่วย (ไทย)', cat: 'หมวด', ok: 'เพิ่ม' },
  linked: 'ผูกกับรายการนับแล้ว',
  notLinked: 'ยังไม่ผูกรายการนับ',
  moreTitle: 'จัดการคำนี้',
  moreActions: [
    { value: 'link', label: 'ผูกกับรายการนับ' },
    { value: 'unlink', label: 'เลิกผูกรายการนับ' },
    { value: 'remove', label: 'ลบคำนี้' }
  ],
  linkTitle: 'เลือกรายการนับที่ตรงกับคำนี้',
  removeAsk: { title: 'ลบคำนี้?', text: 'คำพม่าของคำนี้จะหายไปจากทุกหน้า', ok: 'ลบ' },
  noCat: 'ไม่มีหมวด',
  hint: 'คำในวงเล็บปีกกา เช่น {n} {name} คือช่องที่ระบบเติมตัวเลข/ชื่อให้ ต้องพิมพ์คงไว้ตามเดิม',
  saved: 'บันทึกแล้ว',
  added: 'เพิ่มคำแล้ว',
  removed: 'ลบคำแล้ว',
  empty: 'ไม่มีคำในหมวดนี้',
  emptyFind: 'ไม่พบคำที่ค้นหา'
};

// ปุ่มสวิตช์ภาษาพม่ากำกับทั้งแอป บนแถบบนสุดข้างระฆัง (ปิด = ไทยล้วน · จำแยกทีละเครื่อง)
export const MY_TOGGLE_UI = {
  text: 'พม่า',
  label: 'แสดงภาษาพม่ากำกับทั้งแอป',
  on: 'เปิดภาษาพม่ากำกับแล้ว',
